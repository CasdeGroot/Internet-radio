/*
* NAME: menu_stream
* DESCRIPTION: .c file for the stream menu item
* AUTHORS: Group A1
*/
...
/*
* NAME: menu_streamC_task
* DESCRIPTION: main function for the stream menu
* PARAMS: 
* RETURNS: void
*/
void menu_streamC_task()
{
