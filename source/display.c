 ...
 void LcdLowLevelInit()
{
	...
	default_custom_chars();							// Writes the custom defined glyphs to the custom glyph RAM.
...
/*
* NAME: set_cursor()
* DESCRIPTION: Set the cursor at the given position.
* PARAMS: char position
* RETURNS: void
*/
void set_cursor(char position)
{
...
void clear()
{
	...
	void enable_cursor()
	{
		LcdWriteByte(WRITE_COMMAND, 0x0E);
	}
